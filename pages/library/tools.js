    ...
    <Container metaTags={metaTags}>
      ...
      <Grid>
        <div className="px-4 sm:px-6">
          <h2 className="text-gray-800 dark:text-gray-300 text-4xl font-bold text-center capitalize tracking-wide">
      ...
      <div className="px-4 sm:px-6">
        <Spacer y="1" />
        <h2 className="text-gray-700 dark:text-gray-300 text-2xl font-bold text-left capitalize tracking-wide">
          Development
        </h2>
        <Spacer y="1" />
        <h3 className="text-gray-500 dark:text-gray-300 text-xl text-left capitalize tracking-wide">
      ...
      list.map((item, index) => (
        (item.groupTitle === "Solidity Code Quality") && 
          <Grid className="pl-100 " xs={6} sm={2} key={index} css={{justifyItems:"center", maxwidth:"500"}}>

             <div onClick={()=>{
              handleShowModal(item);
             }} className="toolIcon rounded-md bg-white hover:shadow-gray-700 h-700 max-w-300 max-h-700" color="warning" >
                  <div className="flex flex-col align-middle grow-0" >
                    <div align="center" >
                      <Image
                      src={item.logo}
                      objectFit="fill"
                      ...
                      alt={item.name}
                    /></div>
                    <div align="center"> <Text b size={12}>{item.name}</Text> </div>
                  </div>
             </div>
               <Spacer y={0.5} x={1} />
        </Grid>
      ...
      ))}
      {
              ...
              <div className="custom-Modal flex flex-col overflow-y-auto overflow-x-clip shrink-0 grow-0 max-w-500 h-500">
              <Spacer y={0.5}/>
              <div className="closeModal" onClick={handleCloseModal}>
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <line x1="1.41421" y1="1" x2="19" y2="18.5858" stroke="#8F8F8F" stroke-width="2" stroke-linecap="round"/>
                <line x1="1" y1="-1" x2="25.8701" y2="-1" transform="matrix(-0.707107 0.707107 0.707107 0.707107 20 1)" stroke="#8F8F8F" stroke-width="2" stroke-linecap="round"/>
                </svg>
              </div>
              ...
              <div className="content-center justify-center">
                <Image
                  ...
                  /></div>
                <Spacer y={0.5}/>
                <div className="text-center"><Text b size={18}>{selectedItem.name}</Text></div>
                <Spacer y={0.5}/>
                <div className="text-center overflow-y-auto">{selectedItem.desc}</div>
                <Spacer y={0.5}/>
                <div><a className="webLink" href={selectedItem.website}><Button>Visit Website</Button></a></div>
              </div>
              </div>
              </div>
              )
      ...
      {
              selectedItem && (
              <div className="modalbackcolor backdrop-filter backdrop-blur-md">
              <div className="custom-Modal flex flex-col overflow-y-auto overflow-x-clip shrink-0 grow-0 max-w-500 h-500">
              <Spacer y={0.5}/>
              <div className="closeModal" onClick={handleCloseModal}>
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="px-4 sm:px-6">
        <Spacer y={1} />
        <h2 className="text-gray-700 dark:text-gray-300 text-2xl font-bold text-left tracking-wide">
      ...
      ))}
      {
              ...
              <div className="content-center justify-center">
                ...
                <div className="text-center"><Text b size={18}>{selectedItem.name}</Text></div>
                <Spacer y={0.5}/>
                <div className="text-center overflow-y-auto">Supports Staking: {selectedItem.isSupportStaking}</div>
                <Spacer y={0.5}/>
                <div><a className="webLink" href={selectedItem.website}><Button>Visit Website</Button></a></div>
              </div>
              </div>
